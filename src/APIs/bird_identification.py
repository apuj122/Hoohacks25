...
response = model.generate_content([
    {"type": "text", "text": "You are a professional on birds. Identify the bird in this image and provide the following details: Common Name, Scientific Name, Places this bird can be found (comma-separated list), and one fun fact about this bird."},
